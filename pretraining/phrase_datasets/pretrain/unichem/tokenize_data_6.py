...
def prepare_full(
    ...
    for filepath in filenames:
        ...
        builder = packed_dataset.PackedDatasetBuilder(
            ...
            prefix=f"{split}_unichem_{process_id}_{file_id}",  # Use process_id to differentiate builders
        ...
        with open(filepath, "r") as f:
            for k, row in tqdm(enumerate(f)):
                ...
                if text != decoded_text:
                    print(f"original text: {text} != decoded text: {decoded_text}")
                    continue
...
def prepare(
    ...
    filenames = [f for f in filenames if pattern.fullmatch(os.path.basename(f))]
...
def parse_args():
    ...
    parser.add_argument(
        "--source_path",
        default="../../../../data/raw_data/unichem/aug_smiles/",
    ...
    parser.add_argument(
        "--chunks_path",
        default="../../../../data/pretrain_data/UniChem/chunks_SMILES",
...
if __name__ == "__main__":
    # it will have 781944 train files and 86916 test files
    args = parse_args()
