...
def prepare(
    ...
    import time
    length_list_dir = os.path.join(source_path, "unichem_length_list")
    os.makedirs(length_list_dir, exist_ok=True)

    print(os.path.join(source_path, "smiles_*.txt"))
    filenames = glob.glob(os.path.join(source_path, "smiles_*.txt"))
