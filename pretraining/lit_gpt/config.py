...
mole_LLaMA = [
    ...
    dict(
        org="Clemson",
        name="mole_LLaMA_1b_SMILES",
        block_size=512,
        vocab_size=266, # we use 156 previously
        padding_multiple=64,
        n_layer=22,
        n_head=32,
        n_embd=2048,
